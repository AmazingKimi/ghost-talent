...
def score_candidate(c:Candidate)->dict:
 ...
 if recent_recognized:reasons.append(f"{recent_recognized} recent recognized upstream PR(s)")
 if recent_accepted_core:reasons.append(f"{recent_accepted_core} recent core-path PR(s) approved by a maintainer on the same PR")
