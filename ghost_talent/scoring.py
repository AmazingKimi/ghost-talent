...
def score_candidate(c:Candidate)->dict:
 ...
 already_visible=bool(external>=60 and c.followers>=500);emerging_visibility=bool(c.followers<500);accepted_core=bool(accepted_count>=1 and core_count>=1);credible_upstream=bool(recognized_count>=1 and (accepted_count>=1 or core_count>=1))
